...
def main():
    ...
    d_visual.plot_test_data_overall(results_data, rpb, "Records_per_buffer", d_processor.pass_data_to_plot)
    d_visual.plot_test_data_overall(results_data, bpa, "Buffers_per_acquisition", d_processor.pass_data_to_plot)
